  ...
  const handleApprove = async (action) => {
    ...
    try {
      const payload = {
        ...
        WhitePaper: selected.WhitePaper,
        ...
        Launch_price: selected.Launch_price,
        Total_supply: selected.Total_supply,
        Contract_address: selected.Contract_address,
        Mim_raise_amou: selected.Mim_raise_amou,
        Max_raise_amou: selected.Max_raise_amou,
        Start_date: selected.Start_date,
        End_date: selected.End_date,
        Token_value_in_usdt: selected.Token_value_in_usdt,
        pay_by: selected.pay_by,
        Owner_address: selected.Owner_address,
        Start_date_timeStamp: selected.Start_date_timeStamp,
        End_date_timeStamp: selected.End_date_timeStamp,
        logo: logo,
        Status: action
      }
                            ...
                            <div className='spacex-part'>
                              <Box sx={{ width: '100%' }}>
                                <div className='price-pool'>
                                  <Grid container className="price-pool-block" spacing={2} sx={{ justifyContent: 'center' }}>
                                    {/* {console.log(launchPad, '*******************')} */}
                                    {launchPad.length > 0 ?
                                      launchPad.map((san, ind) => {
                                        return (

                                          <Grid item xl={6} lg={6} md={6} sm={6} xs={12} key={ind}>
                                            <div className="launchpad-price-pool">
                                              <div className="div-content">
                                                <h6 className="pool-text-btn">Pool Price   <Tooltip title={san?.Status ? 'Enable' : 'Disable'} arrow><AntSwitch checked={san?.Status} inputProps={{ 'aria-label': 'ant design' }} /></Tooltip> </h6>
                                                <h3>
                                                  {/* 20,000 SKK */}
                                                  {san?.Launch_price}
                                                </h3>
                                                <h4 style={{ color: 'black' }}>
                                                  ...
                                                  {`${san?.Token_symbol} Airdrop for ZBR Holders`}
                                                </h4>
                                                <p>
                                              ...
                                              <div className='buy-btn'>
                                                <Button className="pricepool-btn" variant="contained" onClick={() => { handleOpen(san) }}>Show</Button>
                                              </div>
                                            </div>
                      ...
                      >
                        <Box sx={style}>
                          <div className='closeicon'>
                            ...
                            <Grid container sx={{ justifyContent: 'center' }} className="admin-popup-cont">
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                Project Name:
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Project_Name}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Project_Name: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Token_Name}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Token_Name: e.target.value });
                                  }} />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Description}
                                  onChange={(e) => {
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Network}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Network: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Website}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Website: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.WhitePaper ? selected?.WhitePaper : '-'}
                                  onChange={(e) => {
                                    setSelected({ ...selected, WhitePaper: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Twitter}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Twitter: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Discord}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Discord: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Instagram}
                                  onChange={(e) => {
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Reddit}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Reddit: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.LinkedIn}
                                  onChange={(e) => {
                                    setSelected({ ...selected, LinkedIn: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Logo} onChange={handleLogoUpdate} />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Token_symbol}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Token_symbol: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Launch_price}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Launch_price: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Total_supply}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Total_supply: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Contract_address}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Contract_address: e.target.value });
                                  }}
                                />

                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                Minimum Raise Amount (soft cap):
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Max_raise_amou}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Max_raise_amou: e.target.value });
                                  }}
                                />

                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                Minimum Raise Amount (hard cap):
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Mim_raise_amou}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Mim_raise_amou: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Start_date ? selected?.Start_date.split('T')[0] : ''}
                                  onChange={(e) => {
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.End_date ? selected?.End_date.split('T')[0] : ''}
                                  onChange={(e) => {
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.pay_by ? selected?.pay_by : ''}
                                  onChange={(e) => {
                                    setSelected({ ...selected, pay_by: e.target.value });
                                  }}
                                />

                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                Token value per USDT :
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
                                <TextField id="outlined-basic" variant="outlined" value={selected?.Token_value_in_usdt ? selected?.Token_value_in_usdt : ''}
                                  onChange={(e) => {
                                    setSelected({ ...selected, Token_value_in_usdt: e.target.value });
                                  }}
                                />
                              ...
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                                ...
                                <div className='approve-btn'>
                                  <Button variant="contained" sx={{ backgroundColor: 'green !important' }} onClick={() => { handleApprove(true) }} disabled={selected?.Status}> {creates ? <CircularProgress /> : 'Approve'} </Button>
                                  {/* <Button variant="contained" sx={{ backgroundColor: 'red !important' }} onClick={() => { handleApprove(false) }} disabled={!selected?.Status} >{selected?.Status ? 'Disable' : 'Decline'}</Button> */}
                                  <Button variant="contained" sx={{ backgroundColor: 'red !important' }} onClick={() => { handleApprove(false) }} disabled={!selected?.Status} >{'Decline'}</Button>
                                </div>
                              </Grid>
                              <Grid item xs={12} sm={12} md={12} lg={12} xl={6}>
